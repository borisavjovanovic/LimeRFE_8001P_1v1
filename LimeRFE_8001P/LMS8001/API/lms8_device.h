...
#ifndef LMS8_DEVICE_H
#define	LMS8_DEVICE_H
#include "../lms8001/LMS8001.h"
...
#include "../lms8001/lmsComms.h"

//class RFE_Device;

//namespace lime {
    class LIME_API LMS8_Device
    {
    public:
        struct Range {
        ...
        virtual ~LMS8_Device();
//        LMS8_Device(LMS8_Device* obj = nullptr);

//        LMS8_Device(lime::IConnection* conn);
        LMS8_Device(LMScomms* conn);

        LMScomms* GetConnection();

//        lime::IConnection* GetConnection(unsigned chan = 0);

//        static LMS8_Device* CreateDevice(const lime::ConnectionHandle& handle, LMS8_Device* obj = nullptr);
//        static LMS8_Device* CreateDevice(const lime::ConnectionHandle& handle);
        static LMS8_Device* CreateDevice();
        static LMS8_Device* CreateDevice(int i);
...
//        std::vector<lime::LMS7002M*> lms_list;
        LMS8001* lms;
//        std::vector<lime::LMS8001*> lms_list;
//        std::vector<LMS8001*> lms_list;
// 
