...
lms8_ADF4002_wxgui::lms8_ADF4002_wxgui(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, int styles, wxString idname)
	: ADF4002_wxgui_view(parent, id, title, pos, size, styles)
{
	m_pModule = NULL;
}

lms8_ADF4002_wxgui::lms8_ADF4002_wxgui(wxWindow *parent)
	: ADF4002_wxgui_view(parent)
{
	m_pModule = NULL;
}

void lms8_ADF4002_wxgui::Initialize(lms8_ADF4002 *pModule, LMScomms *pSerPort)
{
...
void lms8_ADF4002_wxgui::SetGuiDefaults()
{
...
void lms8_ADF4002_wxgui::OnbtnUploadClick(wxCommandEvent &event)
{
	// reference counter latch
...
void lms8_ADF4002_wxgui::OnbtnCalcSendClick(wxCommandEvent &event)
{
	// reference counter latch
	int ldp = cmbLDP->GetSelection();
	int abw = cmbABW->GetSelection();
