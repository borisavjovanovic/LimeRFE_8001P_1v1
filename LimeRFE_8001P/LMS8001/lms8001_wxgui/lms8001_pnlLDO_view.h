...
class lms8001_pnlLDO_view : public pnlLDO_view
{
	protected:
	...
	lms8001_pnlLDO_view(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize, long style = wxTAB_TRAVERSAL);
