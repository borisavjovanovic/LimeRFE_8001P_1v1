...
lms8_dlgConnectionSettings_view::lms8_dlgConnectionSettings_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	...
	// Connect Events
	this->Connect(wxEVT_INIT_DIALOG, wxInitDialogEventHandler(lms8_dlgConnectionSettings_view::GetDeviceList));
	btnConnect->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettings_view::OnConnect), NULL, this);
	btnCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettings_view::OnCancel), NULL, this);
	btnDisconnect->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettings_view::OnDisconnect), NULL, this);
}

lms8_dlgConnectionSettings_view::~lms8_dlgConnectionSettings_view()
{
	// Disconnect Events
	this->Disconnect(wxEVT_INIT_DIALOG, wxInitDialogEventHandler(lms8_dlgConnectionSettings_view::GetDeviceList));
	btnConnect->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettings_view::OnConnect), NULL, this);
	btnCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettings_view::OnCancel), NULL, this);
	btnDisconnect->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettings_view::OnDisconnect), NULL, this);
}

lms8_dlgConnectionSettingsLMS7_view::lms8_dlgConnectionSettingsLMS7_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	this->SetSizeHints(wxDefaultSize, wxDefaultSize);
	...
	// Connect Events
	this->Connect(wxEVT_INIT_DIALOG, wxInitDialogEventHandler(lms8_dlgConnectionSettingsLMS7_view::GetDeviceList));
	btnConnect->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettingsLMS7_view::OnConnect), NULL, this);
	btnCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettingsLMS7_view::OnCancel), NULL, this);
	btnDisconnect->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettingsLMS7_view::OnDisconnect), NULL, this);
}

lms8_dlgConnectionSettingsLMS7_view::~lms8_dlgConnectionSettingsLMS7_view()
{
	// Disconnect Events
	this->Disconnect(wxEVT_INIT_DIALOG, wxInitDialogEventHandler(lms8_dlgConnectionSettingsLMS7_view::GetDeviceList));
	btnConnect->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettingsLMS7_view::OnConnect), NULL, this);
	btnCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettingsLMS7_view::OnCancel), NULL, this);
	btnDisconnect->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgConnectionSettingsLMS7_view::OnDisconnect), NULL, this);
}

lms8_pnlMiniLog_view::lms8_pnlMiniLog_view(wxWindow *parent, wxWindowID id, const wxPoint &pos, const wxSize &size, long style) : wxPanel(parent, id, pos, size, style)
{
	...
	// Connect Events
	this->Connect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(lms8_pnlMiniLog_view::OnUpdateGUI));
	btnClear->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_pnlMiniLog_view::OnBtnClearClicked), NULL, this);
	btnFullLog->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_pnlMiniLog_view::OnShowFullLog), NULL, this);
	chkLogData->Connect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms8_pnlMiniLog_view::OnLogDataClicked), NULL, this);
}

lms8_pnlMiniLog_view::~lms8_pnlMiniLog_view()
{
	// Disconnect Events
	this->Disconnect(wxEVT_UPDATE_UI, wxUpdateUIEventHandler(lms8_pnlMiniLog_view::OnUpdateGUI));
	btnClear->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_pnlMiniLog_view::OnBtnClearClicked), NULL, this);
	btnFullLog->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_pnlMiniLog_view::OnShowFullLog), NULL, this);
	chkLogData->Disconnect(wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler(lms8_pnlMiniLog_view::OnLogDataClicked), NULL, this);
}

lms8_dlgFullMessageLog_view::lms8_dlgFullMessageLog_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxDialog(parent, id, title, pos, size, style)
{
...
lms8_dlgFullMessageLog_view::~lms8_dlgFullMessageLog_view()
{
}

lms8_dlgDeviceInfo_view::lms8_dlgDeviceInfo_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	this->SetSizeHints(wxDefaultSize, wxDefaultSize);
	...
	// Connect Events
	btnGetInfo->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgDeviceInfo_view::OnGetInfo), NULL, this);
}

lms8_dlgDeviceInfo_view::~lms8_dlgDeviceInfo_view()
{
	// Disconnect Events
	btnGetInfo->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgDeviceInfo_view::OnGetInfo), NULL, this);
}

lms8_dlgTempCalibrate_view::lms8_dlgTempCalibrate_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	this->SetSizeHints(wxDefaultSize, wxDefaultSize);
	...
	// Connect Events
	btnCalibrate->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgTempCalibrate_view::OnClick_btnCalibrate), NULL, this);
	btnReset->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgTempCalibrate_view::OnClick_btnReset), NULL, this);
}

lms8_dlgTempCalibrate_view::~lms8_dlgTempCalibrate_view()
{
	// Disconnect Events
	btnCalibrate->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgTempCalibrate_view::OnClick_btnCalibrate), NULL, this);
	btnReset->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_dlgTempCalibrate_view::OnClick_btnReset), NULL, this);
}

lms8_SPI_view::lms8_SPI_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxFrame(parent, id, title, pos, size, style)
{
	this->SetSizeHints(wxDefaultSize, wxDefaultSize);
	...
	// Connect Events
	btnLMSwrite->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onLMSwrite), NULL, this);
	btnLMSread->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onLMSread), NULL, this);
	btnSPIstep->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onSPIstep), NULL, this);
	btnClear->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onClear), NULL, this);
}

lms8_SPI_view::~lms8_SPI_view()
{
	// Disconnect Events
	btnLMSwrite->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onLMSwrite), NULL, this);
	btnLMSread->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onLMSread), NULL, this);
	btnSPIstep->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onSPIstep), NULL, this);
	btnClear->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_SPI_view::onClear), NULL, this);
}

lms8_GPIO_view::lms8_GPIO_view(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long style) : wxFrame(parent, id, title, pos, size, style)
{
	this->SetSizeHints(wxDefaultSize, wxDefaultSize);
	this->SetBackgroundColour(wxSystemSettings::GetColour(wxSYS_COLOUR_BTNFACE));
	...
	// Connect Events
	rgr_GPIO03_DIR->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(lms8_GPIO_view::OnChangeGPIODirection), NULL, this);
	rgr_GPIO47_DIR->Connect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(lms8_GPIO_view::OnChangeGPIODirection), NULL, this);
	btnUpdateClear->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_GPIO_view::OnUpdateClick), NULL, this);
}

lms8_GPIO_view::~lms8_GPIO_view()
{
	// Disconnect Events
	rgr_GPIO03_DIR->Disconnect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(lms8_GPIO_view::OnChangeGPIODirection), NULL, this);
	rgr_GPIO47_DIR->Disconnect(wxEVT_COMMAND_RADIOBOX_SELECTED, wxCommandEventHandler(lms8_GPIO_view::OnChangeGPIODirection), NULL, this);
	btnUpdateClear->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(lms8_GPIO_view::OnUpdateClick), NULL, this);
}
