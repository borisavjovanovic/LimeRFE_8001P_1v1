...
lms8_dlgDeviceInfo::lms8_dlgDeviceInfo(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long styles)
    : lms8_dlgDeviceInfo_view(parent, id, title, pos, size, styles)
{
    ctrPort = nullptr;
    //    dataPort = nullptr;
}
...
/*
void lms8_dlgDeviceInfo::Initialize(LMScomms* pCtrPort, LMScomms* pDataPort)
{
    ctrPort = pCtrPort;
    dataPort = pDataPort;
}
...
void lms8_dlgDeviceInfo::Initialize(LMScomms *pCtrPort)
{
    ctrPort = pCtrPort;
}

void lms8_dlgDeviceInfo::OnGetInfo(wxCommandEvent &event)
{
