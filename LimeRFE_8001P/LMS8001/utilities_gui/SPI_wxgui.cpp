...
lms8_SPI_wxgui::lms8_SPI_wxgui(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long styles)
	: lms8_SPI_view(parent)
{
	ctrPort = nullptr;
	//    dataPort = nullptr;
}
...
/*
void lms8_SPI_wxgui::Initialize(LMScomms* pCtrPort, LMScomms* pDataPort)
{
	ctrPort = pCtrPort;
	dataPort = pDataPort;
...
*/
/*
void lms8_SPI_wxgui::Initialize(LMScomms* pCtrPort)
{
	ctrPort = pCtrPort;
//	dataPort = pDataPort;
	assert(ctrPort != nullptr);
...
*/
void lms8_SPI_wxgui::Initialize(LMScomms *pCtrPort, LMS8001 *pControl)
{
	ctrPort = pCtrPort;
	//	dataPort = pDataPort;
	assert(ctrPort != nullptr);
...
void lms8_SPI_wxgui::onLMSwrite(wxCommandEvent &event)
{
...
void lms8_SPI_wxgui::onLMSread(wxCommandEvent &event)
{
...
void lms8_SPI_wxgui::onSPIstep(wxCommandEvent &event)
{
	...
	if (icmd == 1) // WRITE
	{
		...
		lms8_AppFrame_view *appFrame = (lms8_AppFrame_view *)GetParent();
		// msavic ovdi!
...
void lms8_SPI_wxgui::onClear(wxCommandEvent &event)
{
	txtSPIfield->Clear();
	txtSPIfield_log->Clear();
}
...
/*
void lms8_SPI_wxgui::onBoardWrite( wxCommandEvent& event )
{
...
*/
/*
void lms8_SPI_wxgui::OnBoardRead( wxCommandEvent& event )
{
