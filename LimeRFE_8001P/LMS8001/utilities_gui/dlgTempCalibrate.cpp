...
lms8_dlgTempCalibrate::lms8_dlgTempCalibrate(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long styles)
	: lms8_dlgTempCalibrate_view(parent, id, title, pos, size, styles)
{
}

void lms8_dlgTempCalibrate::Initialize(LMS8001 *pControl)
{
	lmsControl = pControl;
