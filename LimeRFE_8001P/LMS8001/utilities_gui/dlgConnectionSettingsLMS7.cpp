...
lms8_dlgConnectionSettingsLMS7::lms8_dlgConnectionSettingsLMS7(wxWindow *parent)
	: lms8_dlgConnectionSettingsLMS7_view(parent)
{
	lms7port = nullptr;
...
/*
void lms8_dlgConnectionSettingsLMS7::SetConnectionManagers(ConnectionManager* lms7ctr, ConnectionManager* streamBrdctr)
{
	lms7port = lms7ctr;
...
void lms8_dlgConnectionSettingsLMS7::SetConnectionManager(ConnectionManager *lms7ctr)
{
	lms7port = lms7ctr;
}

void lms8_dlgConnectionSettingsLMS7::GetDeviceList(wxInitDialogEvent &event)
{
...
void lms8_dlgConnectionSettingsLMS7::OnConnect(wxCommandEvent &event)
{
	if (lms7port)
	{
...
void lms8_dlgConnectionSettingsLMS7::OnCancel(wxCommandEvent &event)
{
	Destroy();
}

void lms8_dlgConnectionSettingsLMS7::OnDisconnect(wxCommandEvent &event)
{
	if (lms7port)
	{
		lms7port->Close();
