...
lms8_GPIO_wxgui::lms8_GPIO_wxgui(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos, const wxSize &size, long styles)
	: lms8_GPIO_view(parent)
{
	ctrPort = nullptr;
	//    dataPort = nullptr;
}
...
/*
void lms8_GPIO_wxgui::Initialize(LMScomms* pCtrPort, LMScomms* pDataPort)
{
	ctrPort = pCtrPort;
//    dataPort = pDataPort;
...
void lms8_GPIO_wxgui::Initialize(LMScomms *pCtrPort)
{
	ctrPort = pCtrPort;
	//    dataPort = pDataPort;
	assert(ctrPort != nullptr);
...
void lms8_GPIO_wxgui::OnUpdateClick(wxCommandEvent &event)
{
	/*
		//	CMD_GPIO_STP
	//	***********************
...
void lms8_GPIO_wxgui::OnChangeGPIODirection(wxCommandEvent &event)
{
