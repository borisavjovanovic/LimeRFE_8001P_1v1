...
class lms8_Si5351C_wxgui : public Si5351C_wxgui_view
{
protected:
...
public:
	/** Constructor */
	lms8_Si5351C_wxgui(wxWindow *parent, wxWindowID id = wxID_ANY, const wxString &title = _(""), const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, int styles = wxDEFAULT_FRAME_STYLE, wxString idname = "");
