...
#include "./utilities_gui/pnlMiniLog.h"
#include "SPI_wxgui.h"
...
LMS8SuiteAppFrame::LMS8SuiteAppFrame(wxWindow *parent) : lms8_AppFrame_view(parent)
{
#ifndef __unix__
	...
	mMiniLog = new lms8_pnlMiniLog(this, wxNewId());
...
{
	lms8_dlgConnectionSettings dlg(this);
...
void LMS8SuiteAppFrame::OnShowDeviceInfo(wxCommandEvent &event)
{
	...
	{
		deviceInfo = new lms8_dlgDeviceInfo(this, wxNewId(), _("Device Info"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE);
...
void LMS8SuiteAppFrame::OnShowSPI(wxCommandEvent &event)
{
	...
	{
		spi = new lms8_SPI_wxgui(this, wxNewId(), _("Device Info"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE);
...
void LMS8SuiteAppFrame::OnShowGPIO(wxCommandEvent &event)
{
	...
	{
		gpio = new lms8_GPIO_wxgui(this, wxNewId(), _("Device Info"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE);
...
void LMS8SuiteAppFrame::OnShowADF4002(wxCommandEvent &event)
{
	...
	{
		adfGUI = new lms8_ADF4002_wxgui(this, wxNewId(), _("ADF4002"));
...
void LMS8SuiteAppFrame::OnShowSi5351C(wxCommandEvent &event)
{
	...
	{
		si5351gui = new lms8_Si5351C_wxgui(this, wxNewId(), _("Si5351C"), wxDefaultPosition, wxDefaultSize, wxDEFAULT_FRAME_STYLE);
...
#ifndef __unix__
void LMS8SuiteAppFrame::Initialize(HANDLE handle)
{
