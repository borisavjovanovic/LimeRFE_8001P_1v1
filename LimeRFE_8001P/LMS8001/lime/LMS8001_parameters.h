...
static const struct LMS8Parameter RP_CALIB_COMP = { 0x0010, 11, 11, 0, "RP_CALIB_COMP", "Comparator output; Used in rppolywo calibration" };
static const struct LMS8Parameter RP_CALIB_BIAS = { 0x0010, 10, 6, 16, "RP_CALIB_BIAS", "Calibration code for rppolywo; Code is set by calibration algorithm" };
...
static const struct LMS8Parameter SPDUP_LDO_LOBUFA = { 0x0011, 9, 9, 0, "SPDUP_LDO_LOBUFA", "Short the noise filter resistor to speed up the settling time - LDO LOBUF Channel A" };
static const struct LMS8Parameter SPDUP_LDO_LOBUFB = { 0x0012, 9, 9, 0, "SPDUP_LDO_LOBUFB", "Short the noise filter resistor to speed up the settling time - LDO LOBUF Channel B" };
static const struct LMS8Parameter SPDUP_LDO_LOBUFC = { 0x0013, 9, 9, 0, "SPDUP_LDO_LOBUFC", "Short the noise filter resistor to speed up the settling time - LDO LOBUF Channel C" };
static const struct LMS8Parameter SPDUP_LDO_LOBUFD = { 0x0014, 9, 9, 0, "SPDUP_LDO_LOBUFD", "Short the noise filter resistor to speed up the settling time - LDO LOBUF Channel D" };

static const struct LMS8Parameter SPDUP_LDO_HFLNAA = { 0x0015, 9, 9, 0, "SPDUP_LDO_HFLNAA", "Short the noise filter resistor to speed up the settling time - LDO LNA Channel A" };
static const struct LMS8Parameter SPDUP_LDO_HFLNAB = { 0x0016, 9, 9, 0, "SPDUP_LDO_HFLNAB", "Short the noise filter resistor to speed up the settling time - LDO LNA Channel B" };
static const struct LMS8Parameter SPDUP_LDO_HFLNAC = { 0x0017, 9, 9, 0, "SPDUP_LDO_HFLNAC", "Short the noise filter resistor to speed up the settling time - LDO LNA Channel C" };
static const struct LMS8Parameter SPDUP_LDO_HFLNAD = { 0x0018, 9, 9, 0, "SPDUP_LDO_HFLNAD", "Short the noise filter resistor to speed up the settling time - LDO LNA Channel D" };

static const struct LMS8Parameter SPDUP_LDO_CLK_BUF = { 0x001A, 9, 9, 0, "SPDUP_LDO_CLK_BUF", "Short the noise filter resistor to speed up the settling time - LDO CLK" };
static const struct LMS8Parameter SPDUP_LDO_PLL_DIV = { 0x001B, 9, 9, 0, "SPDUP_LDO_PLL_DIV", "Short the noise filter resistor to speed up the settling time - LDO PLL DIV" };
static const struct LMS8Parameter SPDUP_LDO_PLL_CP = { 0x001C, 9, 9, 0, "SPDUP_LDO_PLL_CP", "Short the noise filter resistor to speed up the settling time - LDO PLL CP" };
static const struct LMS8Parameter SPDUP_LDO_DIG_CORE = { 0x001F, 9, 9, 0, "SPDUP_LDO_DIG_CORE", "Short the noise filter resistor to speed up the settling time - LDO DIG" };

static const struct LMS8Parameter EN_LOADIMP_LDO_LOBUFA = { 0x0011, 10, 10, 0, "EN_LOADIMP_LDO_LOBUFA", "Enables the load dependent bias to optimize the load regulation - LDO LOBUF Channel A" };
static const struct LMS8Parameter EN_LOADIMP_LDO_LOBUFB = { 0x0012, 10, 10, 0, "EN_LOADIMP_LDO_LOBUFB", "Enables the load dependent bias to optimize the load regulation - LDO LOBUF Channel B" };
static const struct LMS8Parameter EN_LOADIMP_LDO_LOBUFC = { 0x0013, 10, 10, 0, "EN_LOADIMP_LDO_LOBUFC", "Enables the load dependent bias to optimize the load regulation - LDO LOBUF Channel C" };
static const struct LMS8Parameter EN_LOADIMP_LDO_LOBUFD = { 0x0014, 10, 10, 0, "EN_LOADIMP_LDO_LOBUFD", "Enables the load dependent bias to optimize the load regulation - LDO LOBUF Channel D" };

static const struct LMS8Parameter EN_LOADIMP_LDO_HFLNAA = { 0x0015, 10, 10, 0, "EN_LOADIMP_LDO_HFLNAA", "Enables the load dependent bias to optimize the load regulation - LDO LNA Channel A" };
static const struct LMS8Parameter EN_LOADIMP_LDO_HFLNAB = { 0x0016, 10, 10, 0, "EN_LOADIMP_LDO_HFLNAB", "Enables the load dependent bias to optimize the load regulation - LDO LNA Channel B" };
static const struct LMS8Parameter EN_LOADIMP_LDO_HFLNAC = { 0x0017, 10, 10, 0, "EN_LOADIMP_LDO_HFLNAC", "Enables the load dependent bias to optimize the load regulation - LDO LNA Channel C" };
static const struct LMS8Parameter EN_LOADIMP_LDO_HFLNAD = { 0x0018, 10, 10, 0, "EN_LOADIMP_LDO_HFLNAD", "Enables the load dependent bias to optimize the load regulation - LDO LNA Channel D" };

static const struct LMS8Parameter EN_LOADIMP_LDO_CLK_BUF = { 0x001A, 10, 10, 0, "EN_LOADIMP_LDO_CLK_BUF", "Enables the load dependent bias to optimize the load regulation - LDO CLK" };
static const struct LMS8Parameter EN_LOADIMP_LDO_PLL_DIV = { 0x001B, 10, 10, 0, "EN_LOADIMP_LDO_PLL_DIV", "Enables the load dependent bias to optimize the load regulation - LDO LPLL DIV" };
static const struct LMS8Parameter EN_LOADIMP_LDO_PLL_CP = { 0x001C, 10, 10, 0, "EN_LOADIMP_LDO_PLL_CP", "Enables the load dependent bias to optimize the load regulation - LDO PLL CP" };
static const struct LMS8Parameter EN_LOADIMP_LDO_DIG_CORE = { 0x001F, 10, 10, 0, "EN_LOADIMP_LDO_DIG_CORE", "Enables the load dependent bias to optimize the load regulation - LDO DIG CORE" };

static const struct LMS8Parameter RDIV_LOBUFA = { 0x0011, 7, 0, 101, "RDIV_LOBUFA", "Controls the output voltage - LDO LOBUF Channel A" };
static const struct LMS8Parameter RDIV_LOBUFB = { 0x0012, 7, 0, 101, "RDIV_LOBUFB", "Controls the output voltage - LDO LOBUF Channel B" };
static const struct LMS8Parameter RDIV_LOBUFC = { 0x0013, 7, 0, 101, "RDIV_LOBUFC", "Controls the output voltage - LDO LOBUF Channel C" };
static const struct LMS8Parameter RDIV_LOBUFD = { 0x0014, 7, 0, 101, "RDIV_LOBUFD", "Controls the output voltage - LDO LOBUF Channel D" };

static const struct LMS8Parameter RDIV_HFLNAA = { 0x0015, 7, 0, 101, "RDIV_HFLNAA", "Controls the output voltage - LDO LNA Channel A" };
static const struct LMS8Parameter RDIV_HFLNAB = { 0x0016, 7, 0, 101, "RDIV_HFLNAB", "Controls the output voltage - LDO LNA Channel B" };
static const struct LMS8Parameter RDIV_HFLNAC = { 0x0017, 7, 0, 101, "RDIV_HFLNAC", "Controls the output voltage - LDO LNA Channel C" };
static const struct LMS8Parameter RDIV_HFLNAD = { 0x0018, 7, 0, 101, "RDIV_HFLNAD", "Controls the output voltage - LDO LNA Channel D" };
...
static const struct LMS8Parameter RDIV_DIG_CORE = { 0x001F, 7, 0, 101, "RDIV_DIG_CORE", "Controls the output voltage - LDO DIG CORE" };

static const struct LMS8Parameter CHx_MIXB_ICT = { 0x1000, 9, 5, 16, "CHx_MIXA_ICT", "Controls the bias current of polarization circuit for MIXA" };
static const struct LMS8Parameter CHx_MIXA_ICT = { 0x1000, 4, 0, 16, "CHx_MIXB_ICT", "Controls the bias current of polarization circuit for MIXB" };

static const struct LMS8Parameter CHx_PA_ILIN2X = { 0x1001, 10, 10, 0, "CHx_PA_ILIN2X", "Double the linearization bias current" };
static const struct LMS8Parameter CHx_PA_ICT_LIN = { 0x1001, 9, 5, 16, "CHx_PA_ICT_LIN", "Controls the bias current of linearization section of HFPAD" };
static const struct LMS8Parameter CHx_PA_ICT_MAIN = { 0x1001, 4, 0, 16, "CHx_PA_ICT_MAIN", "Controls the bias current of main gm section of HFPAD" };

static const struct LMS8Parameter CHx_PA_R50_EN0 = { 0x1004, 7, 7, 1, "CHx_PA_R50_EN0", "Controls the switch in series with 50 Ohm resistor to ground at HFPAD input" };
...
static const struct LMS8Parameter CHx_LNA_ICT_LIN0 = { 0x1008, 15, 11, 16, "CHx_LNA_ICT_LIN0", "Controls the bias current of linearization section of LNA" };
static const struct LMS8Parameter CHx_LNA_ICT_MAIN0 = { 0x1008, 10, 6, 16, "CHx_LNA_ICT_MAIN0", "Controls the bias current of main gm section of LNA" };
static const struct LMS8Parameter CHx_LNA_CGSCTRL0 = { 0x1008, 5, 4, 2, "CHx_LNA_CGSCTRL0", "Controls the additional LNA input device gate-source capacitance" };
static const struct LMS8Parameter CHx_LNA_GCTRL0 = { 0x1008, 3, 0, 8, "CHx_LNA_GCTRL0", "Controls the LNA gain" };

static const struct LMS8Parameter CHx_PA_LIN_LOSS0 = { 0x100C, 7, 4, 0, "CHx_PA_LIN_LOSS0", "Controls the gain of HFPAD linearizing section" };
static const struct LMS8Parameter CHx_PA_MAIN_LOSS0 = { 0x100C, 3, 0, 0, "CHx_PA_MAIN_LOSS0", "Controls the gain of HFPAD main section" };

static const struct LMS8Parameter CHx_PA_R50_EN1 = { 0x1005, 7, 7, 1, "CHx_PA_R50_EN1", "Controls the switch in series with 50 Ohm resistor to ground at HFPAD input" };
...
static const struct LMS8Parameter CHx_LNA_ICT_LIN1 = { 0x1009, 15, 11, 16, "CHx_LNA_ICT_LIN1", "Controls the bias current of linearization section of LNA" };
static const struct LMS8Parameter CHx_LNA_ICT_MAIN1 = { 0x1009, 10, 6, 16, "CHx_LNA_ICT_MAIN1", "Controls the bias current of main gm section of LNA" };
static const struct LMS8Parameter CHx_LNA_CGSCTRL1 = { 0x1009, 5, 4, 2, "CHx_LNA_CGSCTRL1", "Controls the additional LNA input device gate-source capacitance" };
static const struct LMS8Parameter CHx_LNA_GCTRL1 = { 0x1009, 3, 0, 8, "CHx_LNA_GCTRL1", "Controls the LNA gain" };

static const struct LMS8Parameter CHx_PA_LIN_LOSS1 = { 0x100D, 7, 4, 0, "CHx_PA_LIN_LOSS1", "Controls the gain of HFPAD linearizing section" };
static const struct LMS8Parameter CHx_PA_MAIN_LOSS1 = { 0x100D, 3, 0, 0, "CHx_PA_MAIN_LOSS1", "Controls the gain of HFPAD main section" };

static const struct LMS8Parameter CHx_PA_R50_EN2 = { 0x1006, 7, 7, 1, "CHx_PA_R50_EN2", "Controls the switch in series with 50 Ohm resistor to ground at HFPAD input" };
...
static const struct LMS8Parameter CHx_LNA_ICT_LIN2 = { 0x100A, 15, 11, 16, "CHx_LNA_ICT_LIN2", "Controls the bias current of linearization section of LNA" };
static const struct LMS8Parameter CHx_LNA_ICT_MAIN2 = { 0x100A, 10, 6, 16, "CHx_LNA_ICT_MAIN2", "Controls the bias current of main gm section of LNA" };
static const struct LMS8Parameter CHx_LNA_CGSCTRL2 = { 0x100A, 5, 4, 2, "CHx_LNA_CGSCTRL2", "Controls the additional LNA input device gate-source capacitance" };
static const struct LMS8Parameter CHx_LNA_GCTRL2 = { 0x100A, 3, 0, 8, "CHx_LNA_GCTRL2", "Controls the LNA gain" };

static const struct LMS8Parameter CHx_PA_LIN_LOSS2 = { 0x100E, 7, 4, 0, "CHx_PA_LIN_LOSS2", "Controls the gain of HFPAD linearizing section" };
static const struct LMS8Parameter CHx_PA_MAIN_LOSS2 = { 0x100E, 3, 0, 0, "CHx_PA_MAIN_LOSS2", "Controls the gain of HFPAD main section" };

static const struct LMS8Parameter CHx_PA_R50_EN3 = { 0x1007, 7, 7, 1, "CHx_PA_R50_EN3", "Controls the switch in series with 50 Ohm resistor to ground at HFPAD input" };
...
static const struct LMS8Parameter CHx_LNA_ICT_LIN3 = { 0x100B, 15, 11, 16, "CHx_LNA_ICT_LIN3", "Controls the bias current of linearization section of LNA" };
static const struct LMS8Parameter CHx_LNA_ICT_MAIN3 = { 0x100B, 10, 6, 16, "CHx_LNA_ICT_MAIN3", "Controls the bias current of main gm section of LNA" };
static const struct LMS8Parameter CHx_LNA_CGSCTRL3 = { 0x100B, 5, 4, 2, "CHx_LNA_CGSCTRL3", "Controls the additional LNA input device gate-source capacitance" };
static const struct LMS8Parameter CHx_LNA_GCTRL3 = { 0x100B, 3, 0, 8, "CHx_LNA_GCTRL3", "Controls the LNA gain" };

static const struct LMS8Parameter CHx_PA_LIN_LOSS3 = { 0x100F, 7, 4, 0, "CHx_PA_LIN_LOSS3", "Controls the gain of HFPAD linearizing section" };
static const struct LMS8Parameter CHx_PA_MAIN_LOSS3 = { 0x100F, 3, 0, 0, "CHx_PA_MAIN_LOSS3", "Controls the gain of HFPAD main section" };

static const struct LMS8Parameter CHx_PA_R50_EN_RB = { 0x101D, 7, 7, 1, "CHx_PA_R50_EN_RB", "Controls the switch in series with 50 Ohm resistor to ground at HFPAD input - Readback" };
static const struct LMS8Parameter CHx_PA_BYPASS_RB = { 0x101D, 6, 6, 0, "CHx_PA_BYPASS3_RB", "Controls the HFPAD bypass switches - Readback" };
static const struct LMS8Parameter CHx_PA_PD_RB = { 0x101D, 5, 5, 1, "CHx_PA_PD_RB", "Power down for HFPAD - Readback" };
static const struct LMS8Parameter CHx_MIXB_LOBUFF_PD_RB = { 0x101D, 4, 4, 1, "CHx_MIXB_LOBUFF_PD_RB", "Power down for MIXB LO buffer - Readback" };
static const struct LMS8Parameter CHx_MIXB_BIAS_PD_RB = { 0x101D, 3, 3, 1, "CHx_MIXB_BIAS_PD_RB", "Power down for MIXB bias - Readback" };
static const struct LMS8Parameter CHx_MIXA_LOBUFF_PD_RB = { 0x101D, 2, 2, 1, "CHx_MIXA_LOBUFF_PD_RB", "Power down for MIXA LO buffer - Readback" };
static const struct LMS8Parameter CHx_MIXA_BIAS_PD_RB = { 0x101D, 1, 1, 1, "CHx_MIXA_BIAS_PD_RB", "Power down for MIXA bias - Readback" };
static const struct LMS8Parameter CHx_LNA_PD_RB = { 0x101D, 0, 0, 1, "CHx_LNA_PD_RB", "Power down for LNA - Readback" };

static const struct LMS8Parameter CHx_LNA_ICT_LIN_RB = { 0x101E, 15, 11, 16, "CHx_LNA_ICT_LIN_RB", "Controls the bias current of linearization section of LNA - Readback" };
static const struct LMS8Parameter CHx_LNA_ICT_MAIN_RB = { 0x101E, 10, 6, 16, "CHx_LNA_ICT_MAIN_RB", "Controls the bias current of main gm section of LNA - Readback" };
static const struct LMS8Parameter CHx_LNA_CGSCTRL_RB = { 0x101E, 5, 4, 2, "CHx_LNA_CGSCTRL_RB", "Controls the additional LNA input device gate-source capacitance - Readback" };
static const struct LMS8Parameter CHx_LNA_GCTRL_RB = { 0x101E, 3, 0, 8, "CHx_LNA_GCTRL_RB", "Controls the LNA gain - Readback" };

static const struct LMS8Parameter CHx_PA_LIN_LOSS_RB = { 0x101F, 7, 4, 0, "CHx_PA_LIN_LOSS_RB", "Controls the gain of HFPAD linearizing section - Readback" };
static const struct LMS8Parameter CHx_PA_MAIN_LOSS_RB = { 0x101F, 3, 0, 0, "CHx_PA_MAIN_LOSS_RB", "Controls the gain of HFPAD main section - Readback" };

static const struct LMS8Parameter CHx_PD_SEL0_INTERNAL = { 0x1010, 11, 11, 1, "CHx_PD_SEL0_INTERNAL", "PD control signals multiplexer SEL0 signal is internal" };
static const struct LMS8Parameter CHx_PD_SEL0_INVERT = { 0x1010, 10, 10, 0, "CHx_PD_SEL0_INVERT", "Invert the SEL0 signal of PD control signals" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK0 = { 0x1010, 0, 0, 0, "CHx_PD_SEL0_MASK0", "GPIO0 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK1 = { 0x1010, 1, 1, 0, "CHx_PD_SEL0_MASK1", "GPIO1 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK2 = { 0x1010, 2, 2, 0, "CHx_PD_SEL0_MASK2", "GPIO2 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK3 = { 0x1010, 3, 3, 0, "CHx_PD_SEL0_MASK3", "GPIO3 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK4 = { 0x1010, 4, 4, 0, "CHx_PD_SEL0_MASK4", "GPIO4 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK5 = { 0x1010, 5, 5, 0, "CHx_PD_SEL0_MASK5", "GPIO5 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK6 = { 0x1010, 6, 6, 0, "CHx_PD_SEL0_MASK6", "GPIO6 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK7 = { 0x1010, 7, 7, 0, "CHx_PD_SEL0_MASK7", "GPIO7 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL0_MASK8 = { 0x1010, 8, 8, 0, "CHx_PD_SEL0_MASK8", "GPIO8 mask for SEL0 signal of PD control signals multiplexer" };

static const struct LMS8Parameter CHx_PD_SEL1_INTERNAL = { 0x1011, 11, 11, 1, "CHx_PD_SEL1_INTERNAL", "PD control signals multiplexer SEL1 signal is internal" };
static const struct LMS8Parameter CHx_PD_SEL1_INVERT = { 0x1011, 10, 10, 0, "CHx_PD_SEL1_INVERT", "Invert the SEL1 signal of PD control signals" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK0 = { 0x1011, 0, 0, 0, "CHx_PD_SEL1_MASK0", "GPIO0 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK1 = { 0x1011, 1, 1, 0, "CHx_PD_SEL1_MASK1", "GPIO1 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK2 = { 0x1011, 2, 2, 0, "CHx_PD_SEL1_MASK2", "GPIO2 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK3 = { 0x1011, 3, 3, 0, "CHx_PD_SEL1_MASK3", "GPIO3 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK4 = { 0x1011, 4, 4, 0, "CHx_PD_SEL1_MASK4", "GPIO4 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK5 = { 0x1011, 5, 5, 0, "CHx_PD_SEL1_MASK5", "GPIO5 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK6 = { 0x1011, 6, 6, 0, "CHx_PD_SEL1_MASK6", "GPIO6 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK7 = { 0x1011, 7, 7, 0, "CHx_PD_SEL1_MASK7", "GPIO7 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PD_SEL1_MASK8 = { 0x1011, 8, 8, 0, "CHx_PD_SEL1_MASK8", "GPIO8 mask for SEL1 signal of PD control signals multiplexer" };

static const struct LMS8Parameter CHx_LNA_SEL0_INTERNAL = { 0x1012, 11, 11, 1, "CHx_LNA_SEL0_INTERNAL", "PD control signals multiplexer SEL0 signal is internal" };
static const struct LMS8Parameter CHx_LNA_SEL0_INVERT = { 0x1012, 10, 10, 0, "CHx_LNA_SEL0_INVERT", "Invert the SEL0 signal of PD control signals" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK0 = { 0x1012, 0, 0, 0, "CHx_LNA_SEL0_MASK0", "GPIO0 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK1 = { 0x1012, 1, 1, 0, "CHx_LNA_SEL0_MASK1", "GPIO1 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK2 = { 0x1012, 2, 2, 0, "CHx_LNA_SEL0_MASK2", "GPIO2 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK3 = { 0x1012, 3, 3, 0, "CHx_LNA_SEL0_MASK3", "GPIO3 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK4 = { 0x1012, 4, 4, 0, "CHx_LNA_SEL0_MASK4", "GPIO4 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK5 = { 0x1012, 5, 5, 0, "CHx_LNA_SEL0_MASK5", "GPIO5 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK6 = { 0x1012, 6, 6, 0, "CHx_LNA_SEL0_MASK6", "GPIO6 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK7 = { 0x1012, 7, 7, 0, "CHx_LNA_SEL0_MASK7", "GPIO7 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL0_MASK8 = { 0x1012, 8, 8, 0, "CHx_LNA_SEL0_MASK8", "GPIO8 mask for SEL0 signal of PD control signals multiplexer" };

static const struct LMS8Parameter CHx_LNA_SEL1_INTERNAL = { 0x1013, 11, 11, 1, "CHx_LNA_SEL1_INTERNAL", "PD control signals multiplexer SEL1 signal is internal" };
static const struct LMS8Parameter CHx_LNA_SEL1_INVERT = { 0x1013, 10, 10, 0, "CHx_LNA_SEL1_INVERT", "Invert the SEL1 signal of PD control signals" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK0 = { 0x1013, 0, 0, 0, "CHx_LNA_SEL1_MASK0", "GPIO0 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK1 = { 0x1013, 1, 1, 0, "CHx_LNA_SEL1_MASK1", "GPIO1 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK2 = { 0x1013, 2, 2, 0, "CHx_LNA_SEL1_MASK2", "GPIO2 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK3 = { 0x1013, 3, 3, 0, "CHx_LNA_SEL1_MASK3", "GPIO3 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK4 = { 0x1013, 4, 4, 0, "CHx_LNA_SEL1_MASK4", "GPIO4 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK5 = { 0x1013, 5, 5, 0, "CHx_LNA_SEL1_MASK5", "GPIO5 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK6 = { 0x1013, 6, 6, 0, "CHx_LNA_SEL1_MASK6", "GPIO6 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK7 = { 0x1013, 7, 7, 0, "CHx_LNA_SEL1_MASK7", "GPIO7 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_LNA_SEL1_MASK8 = { 0x1013, 8, 8, 0, "CHx_LNA_SEL1_MASK8", "GPIO8 mask for SEL1 signal of PD control signals multiplexer" };

static const struct LMS8Parameter CHx_PA_SEL0_INTERNAL = { 0x1014, 11, 11, 1, "CHx_PA_SEL0_INTERNAL", "PD control signals multiplexer SEL0 signal is internal" };
static const struct LMS8Parameter CHx_PA_SEL0_INVERT = { 0x1014, 10, 10, 0, "CHx_PA_SEL0_INVERT", "Invert the SEL0 signal of PD control signals" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK0 = { 0x1014, 0, 0, 0, "CHx_PA_SEL0_MASK0", "GPIO0 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK1 = { 0x1014, 1, 1, 0, "CHx_PA_SEL0_MASK1", "GPIO1 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK2 = { 0x1014, 2, 2, 0, "CHx_PA_SEL0_MASK2", "GPIO2 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK3 = { 0x1014, 3, 3, 0, "CHx_PA_SEL0_MASK3", "GPIO3 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK4 = { 0x1014, 4, 4, 0, "CHx_PA_SEL0_MASK4", "GPIO4 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK5 = { 0x1014, 5, 5, 0, "CHx_PA_SEL0_MASK5", "GPIO5 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK6 = { 0x1014, 6, 6, 0, "CHx_PA_SEL0_MASK6", "GPIO6 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK7 = { 0x1014, 7, 7, 0, "CHx_PA_SEL0_MASK7", "GPIO7 mask for SEL0 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL0_MASK8 = { 0x1014, 8, 8, 0, "CHx_PA_SEL0_MASK8", "GPIO8 mask for SEL0 signal of PD control signals multiplexer" };

static const struct LMS8Parameter CHx_PA_SEL1_INTERNAL = { 0x1015, 11, 11, 1, "CHx_PA_SEL1_INTERNAL", "PD control signals multiplexer SEL1 signal is internal" };
static const struct LMS8Parameter CHx_PA_SEL1_INVERT = { 0x1015, 10, 10, 0, "CHx_PA_SEL1_INVERT", "Invert the SEL1 signal of PD control signals" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK0 = { 0x1015, 0, 0, 0, "CHx_PA_SEL1_MASK0", "GPIO0 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK1 = { 0x1015, 1, 1, 0, "CHx_PA_SEL1_MASK1", "GPIO1 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK2 = { 0x1015, 2, 2, 0, "CHx_PA_SEL1_MASK2", "GPIO2 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK3 = { 0x1015, 3, 3, 0, "CHx_PA_SEL1_MASK3", "GPIO3 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK4 = { 0x1015, 4, 4, 0, "CHx_PA_SEL1_MASK4", "GPIO4 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK5 = { 0x1015, 5, 5, 0, "CHx_PA_SEL1_MASK5", "GPIO5 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK6 = { 0x1015, 6, 6, 0, "CHx_PA_SEL1_MASK6", "GPIO6 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK7 = { 0x1015, 7, 7, 0, "CHx_PA_SEL1_MASK7", "GPIO7 mask for SEL1 signal of PD control signals multiplexer" };
static const struct LMS8Parameter CHx_PA_SEL1_MASK8 = { 0x1015, 8, 8, 0, "CHx_PA_SEL1_MASK8", "GPIO8 mask for SEL1 signal of PD control signals multiplexer" };

static const struct LMS8Parameter CHx_PD_INT_SEL0 = { 0x1016, 0, 0, 0, "CHx_PD_INT_SEL0", "Internal value of PD control signals multiplexer selection signals - Bit 0" };
static const struct LMS8Parameter CHx_PD_INT_SEL1 = { 0x1016, 1, 1, 0, "CHx_PD_INT_SEL1", "Internal value of PD control signals multiplexer selection signals - Bit 1" };

static const struct LMS8Parameter CHx_LNA_INT_SEL0 = { 0x1016, 2, 2, 0, "CHx_LNA_INT_SEL0", "Internal value of LNA control signals multiplexer selection signals - Bit 0" };
static const struct LMS8Parameter CHx_LNA_INT_SEL1 = { 0x1016, 3, 3, 0, "CHx_LNA_INT_SEL1", "Internal value of LNA control signals multiplexer selection signals - Bit 1" };

static const struct LMS8Parameter CHx_PA_INT_SEL0 = { 0x1016, 4, 4, 0, "CHx_PA_INT_SEL0", "Internal value of PA control signals multiplexer selection signals - Bit 0" };
static const struct LMS8Parameter CHx_PA_INT_SEL1 = { 0x1016, 5, 5, 0, "CHx_PA_INT_SEL1", "Internal value of PA control signals multiplexer selection signals - Bit 1" };
...
static const struct LMS8Parameter HLMIXx_ICT_BIAS_RB = { 0x200E, 6, 2, 0, "HLMIXx_ICT_BIAS_RB", "HLMIX core bias current control - Readback" };
static const struct LMS8Parameter HLMIXx_BIAS_PD_RB = { 0x200E, 1, 1, 0, "HLMIXx_BIAS_PD_RB", "HLMIX core bias control - Readback" };
static const struct LMS8Parameter HLMIXx_LOBUF_PD_RB = { 0x200E, 0, 0, 0, "HLMIXx_LOBUF_PD_RB", "HLMIX LO buffer power down - Readback" };
static const struct LMS8Parameter HLMIXx_MIXLOSS_RB = { 0x200F, 5, 2, 0, "HLMIXx_MIXLOSS_RB", "HLMIX loss control - Readback" };

static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_INTERNAL = { 0x2008, 11, 11, 1, "HLMIXx_CONFIG_SEL0_INTERNAL", "HLMIX bias control signals multiplexer SEL0 signal is internal" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_INVERT = { 0x2008, 10, 10, 0, "HLMIXx_CONFIG_SEL0_INVERT", "Invert the SEL0 signal of HLMIX bias control signals" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK0 = { 0x2008, 0, 0, 0, "HLMIXx_CONFIG_SEL0_MASK0", "GPIO0 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK1 = { 0x2008, 1, 1, 0, "HLMIXx_CONFIG_SEL0_MASK1", "GPIO1 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK2 = { 0x2008, 2, 2, 0, "HLMIXx_CONFIG_SEL0_MASK2", "GPIO2 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK3 = { 0x2008, 3, 3, 0, "HLMIXx_CONFIG_SEL0_MASK3", "GPIO3 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK4 = { 0x2008, 4, 4, 0, "HLMIXx_CONFIG_SEL0_MASK4", "GPIO4 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK5 = { 0x2008, 5, 5, 0, "HLMIXx_CONFIG_SEL0_MASK5", "GPIO5 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK6 = { 0x2008, 6, 6, 0, "HLMIXx_CONFIG_SEL0_MASK6", "GPIO6 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK7 = { 0x2008, 7, 7, 0, "HLMIXx_CONFIG_SEL0_MASK7", "GPIO7 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL0_MASK8 = { 0x2008, 8, 8, 0, "HLMIXx_CONFIG_SEL0_MASK8", "GPIO8 mask for SEL0 signal of HLMIXx bias control signals multiplexer" };

static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_INTERNAL = { 0x2009, 11, 11, 1, "HLMIXx_CONFIG_SEL1_INTERNAL", "HLMIX bias control signals multiplexer SEL1 signal is internal" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_INVERT = { 0x2009, 10, 10, 0, "HLMIXx_CONFIG_SEL1_INVERT", "Invert the SEL1 signal of HLMIX bias control signals" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK0 = { 0x2009, 0, 0, 0, "HLMIXx_CONFIG_SEL1_MASK0", "GPIO0 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK1 = { 0x2009, 1, 1, 0, "HLMIXx_CONFIG_SEL1_MASK1", "GPIO1 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK2 = { 0x2009, 2, 2, 0, "HLMIXx_CONFIG_SEL1_MASK2", "GPIO2 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK3 = { 0x2009, 3, 3, 0, "HLMIXx_CONFIG_SEL1_MASK3", "GPIO3 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK4 = { 0x2009, 4, 4, 0, "HLMIXx_CONFIG_SEL1_MASK4", "GPIO4 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK5 = { 0x2009, 5, 5, 0, "HLMIXx_CONFIG_SEL1_MASK5", "GPIO5 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK6 = { 0x2009, 6, 6, 0, "HLMIXx_CONFIG_SEL1_MASK6", "GPIO6 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK7 = { 0x2009, 7, 7, 0, "HLMIXx_CONFIG_SEL1_MASK7", "GPIO7 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_CONFIG_SEL1_MASK8 = { 0x2009, 8, 8, 0, "HLMIXx_CONFIG_SEL1_MASK8", "GPIO8 mask for SEL1 signal of HLMIXx bias control signals multiplexer" };

static const struct LMS8Parameter HLMIXx_CONFIG_INT_SEL0 = { 0x200C, 0, 0, 0, "HLMIXx_CONFIG_INT_SEL0", "Internal value of HLMIX control signals multiplexer selection signals - Bit 0" };
static const struct LMS8Parameter HLMIXx_CONFIG_INT_SEL1 = { 0x200C, 1, 1, 0, "HLMIXx_CONFIG_INT_SEL1", "Internal value of HLMIX control signals multiplexer selection signals - Bit 1" };

static const struct LMS8Parameter HLMIXx_LOSS_SEL0_INTERNAL = { 0x200A, 11, 11, 1, "HLMIXx_LOSS_SEL0_INTERNAL", "HLMIX loss control signals multiplexer SEL0 signal is internal" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_INVERT = { 0x200A, 10, 10, 0, "HLMIXx_LOSS_SEL0_INVERT", "Invert the SEL0 signal of HLMIX loss control signals" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK0 = { 0x200A, 0, 0, 0, "HLMIXx_LOSS_SEL0_MASK0", "GPIO0 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK1 = { 0x200A, 1, 1, 0, "HLMIXx_LOSS_SEL0_MASK1", "GPIO1 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK2 = { 0x200A, 2, 2, 0, "HLMIXx_LOSS_SEL0_MASK2", "GPIO2 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK3 = { 0x200A, 3, 3, 0, "HLMIXx_LOSS_SEL0_MASK3", "GPIO3 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK4 = { 0x200A, 4, 4, 0, "HLMIXx_LOSS_SEL0_MASK4", "GPIO4 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK5 = { 0x200A, 5, 5, 0, "HLMIXx_LOSS_SEL0_MASK5", "GPIO5 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK6 = { 0x200A, 6, 6, 0, "HLMIXx_LOSS_SEL0_MASK6", "GPIO6 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK7 = { 0x200A, 7, 7, 0, "HLMIXx_LOSS_SEL0_MASK7", "GPIO7 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL0_MASK8 = { 0x200A, 8, 8, 0, "HLMIXx_LOSS_SEL0_MASK8", "GPIO8 mask for SEL0 signal of HLMIXx loss control signals multiplexer" };

static const struct LMS8Parameter HLMIXx_LOSS_SEL1_INTERNAL = { 0x200B, 11, 11, 1, "HLMIXx_LOSS_SEL1_INTERNAL", "HLMIX loss control signals multiplexer SEL1 signal is internal" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_INVERT = { 0x200B, 10, 10, 0, "HLMIXx_LOSS_SEL1_INVERT", "Invert the SEL1 signal of HLMIX loss control signals" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK0 = { 0x200B, 0, 0, 0, "HLMIXx_LOSS_SEL1_MASK0", "GPIO0 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK1 = { 0x200B, 1, 1, 0, "HLMIXx_LOSS_SEL1_MASK1", "GPIO1 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK2 = { 0x200B, 2, 2, 0, "HLMIXx_LOSS_SEL1_MASK2", "GPIO2 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK3 = { 0x200B, 3, 3, 0, "HLMIXx_LOSS_SEL1_MASK3", "GPIO3 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK4 = { 0x200B, 4, 4, 0, "HLMIXx_LOSS_SEL1_MASK4", "GPIO4 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK5 = { 0x200B, 5, 5, 0, "HLMIXx_LOSS_SEL1_MASK5", "GPIO5 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK6 = { 0x200B, 6, 6, 0, "HLMIXx_LOSS_SEL1_MASK6", "GPIO6 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK7 = { 0x200B, 7, 7, 0, "HLMIXx_LOSS_SEL1_MASK7", "GPIO7 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };
static const struct LMS8Parameter HLMIXx_LOSS_SEL1_MASK8 = { 0x200B, 8, 8, 0, "HLMIXx_LOSS_SEL1_MASK8", "GPIO8 mask for SEL1 signal of HLMIXx loss control signals multiplexer" };

static const struct LMS8Parameter HLMIXx_LOSS_INT_SEL0 = { 0x200C, 2, 2, 0, "HLMIXx_LOSS_INT_SEL0", "Internal value of HLMIX loss control signals multiplexer selection signals - Bit 0" };
static const struct LMS8Parameter HLMIXx_LOSS_INT_SEL1 = { 0x200C, 3, 3, 0, "HLMIXx_LOSS_INT_SEL1", "Internal value of HLMIX loss control signals multiplexer selection signals - Bit 1" };
...
static const struct LMS8Parameter CURLIM_VCOREG = { 0x4000, 9, 9, 1, "CURLIM_VCOREG", "Enables output current limitation in the VCO LDO" };
static const struct LMS8Parameter SPDUP_VCOREG = { 0x4000, 8, 8, 0, "SPDUP_VCOREG", "Shorts the noise filter resistor in the VCO LDO for fast settling time" };
static const struct LMS8Parameter VDIV_VCOREG = { 0x4000, 7, 0, 32, "VDIV_VCOREG", "Controls the VCO LDO Output Voltage" };

static const struct LMS8Parameter PLL_XBUF_SLFBEN = { 0x4001, 2, 2, 0, "PLL_XBUF_SLFBEN", "Enables self-biasing at the input of the XBUF" };
...
static const struct LMS8Parameter FCAL_START = { 0x4002, 12, 12, 0, "FCAL_START", "Starts the automatic VCO frequency calibration algorithm (sticky-bit)" };
static const struct LMS8Parameter VCO_SEL_FINAL_VAL = { 0x4002, 11, 11, 0, "VCO_SEL_FINAL_VAL", "Valid bit for VCO_SEL_FINAL<1:0> result of automatic VCO frequency calibration process" };
static const struct LMS8Parameter VCO_SEL_FINAL = { 0x4002, 10, 9, 0, "VCO_SEL_FINAL", "Defines the optimal VCO core for synthesizing the targeted LO frequency" };
static const struct LMS8Parameter FREQ_FINAL_VAL = { 0x4002, 8, 8, 0, "FREQ_FINAL_VAL", "Valid bit for VCO_FREQ_FINAL<7:0>result of automatic VCO frequency calibration process" };
static const struct LMS8Parameter FREQ_FINAL = { 0x4002, 7, 0, 0, "FREQ_FINAL", "Defines the optimal cap bank configuration of the active LC-VCO core for synthesizing the targeted LO frequency" };
static const struct LMS8Parameter VCO_SEL_FORCE = { 0x4003, 13, 13, 0, "VCO_SEL_FORCE", "Forces the user-defined VCO_SEL_INIT<1:0> word to select the active LC-VCO core and skips the VCO auto-select process during automatic VCO frequency calibration" };
static const struct LMS8Parameter VCO_SEL_INIT = { 0x4003, 12, 11, 2, "VCO_SEL_INIT", "Defines active LC-VCO core when skipping the VCO auto-select process" };
static const struct LMS8Parameter FREQ_INIT_POS = { 0x4003, 10, 8, 7, "FREQ_INIT_POS", "Defines the starting bit-position for optimal cap-bank binary search process for the active LC-VCO core" };
static const struct LMS8Parameter FREQ_INIT = { 0x4003, 7, 0, 0, "FREQ_INIT", "Initial cap bank configuration for binary search process during the automatic VCO frequency calibration" };
static const struct LMS8Parameter FREQ_SETTLING_N = { 0x4004, 11, 8, 4, "FREQ_SETTLING_N", "VCO oscillation frequency settling-time during auto-calibration after updating cap bank configuration; Expressed as the number of reference clock cycles" };
static const struct LMS8Parameter VTUNE_WAIT_N = { 0x4004, 7, 0, 64, "VTUNE_WAIT_N", "VCO tuning-voltage settling time at the beginning of the auto-calibration after opening the PLL loop; Expressed as the number of reference clock cycles" };
static const struct LMS8Parameter VCO_SEL_FREQ_MAX = { 0x4005, 15, 8, 250, "VCO_SEL_FREQ_MAX", "High-frequency cap-bank configuration used during VCO auto-select process" };
static const struct LMS8Parameter VCO_SEL_FREQ_MIN = { 0x4005, 7, 0, 5, "VCO_SEL_FREQ_MIN", "Low-frequency cap-bank configuration used during VCO auto-select process" };

static const struct LMS8Parameter VCO_FREQ_MAN = { 0x4006, 15, 8, 128, "VCO_FREQ_MAN", "Cap Bank configuration multiplexed to the input of active VCO core when manual VCO calibration mode is selected" };
static const struct LMS8Parameter VCO_SEL_MAN = { 0x4006, 7, 6, 2, "VCO_SEL_MAN", "VCO select word for choosing the active VCO core when manual VCO calibration mode is selected" };
...
static const struct LMS8Parameter CTUNE_STEP_DONE = { 0x4006, 2, 2, 0, "CTUNE_STEP_DONE", "VCO Frequency Estimator Output signalizes the end of VCO coarse-tuning step" };
static const struct LMS8Parameter CTUNE_START = { 0x4006, 1, 1, 0, "CTUNE_START", "Starts the process of estimating the VCO oscillation frequency" };
static const struct LMS8Parameter CTUNE_EN = { 0x4006, 0, 0, 0, "CTUNE_EN", "Starts the process of estimating the VCO oscillation frequency" };

static const struct LMS8Parameter PLL_CFG_SEL0_INTERNAL = { 0x4008, 11, 11, 1, "PLL_CFG_SEL0_INTERNAL", "PLL profile multiplexer SEL0 signal is generated from" };
static const struct LMS8Parameter PLL_CFG_SEL0_INVERT = { 0x4008, 10, 10, 0, "PLL_CFG_SEL0_INVERT", "Invert the SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK0 = { 0x4008, 0, 0, 0, "PLL_CFG_SEL0_MASK0", "GPIO0 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK1 = { 0x4008, 1, 1, 0, "PLL_CFG_SEL0_MASK1", "GPIO1 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK2 = { 0x4008, 2, 2, 0, "PLL_CFG_SEL0_MASK2", "GPIO2 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK3 = { 0x4008, 3, 3, 0, "PLL_CFG_SEL0_MASK3", "GPIO3 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK4 = { 0x4008, 4, 4, 0, "PLL_CFG_SEL0_MASK4", "GPIO4 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK5 = { 0x4008, 5, 5, 0, "PLL_CFG_SEL0_MASK5", "GPIO5 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK6 = { 0x4008, 6, 6, 0, "PLL_CFG_SEL0_MASK6", "GPIO6 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK7 = { 0x4008, 7, 7, 0, "PLL_CFG_SEL0_MASK7", "GPIO7 mask for SEL0 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL0_MASK8 = { 0x4008, 8, 8, 0, "PLL_CFG_SEL0_MASK8", "GPIO8 mask for SEL0 signal of PLL profile multiplexer" };

static const struct LMS8Parameter PLL_CFG_SEL0 = { 0x4008, 11, 0, 0x0800, "PLL_CFG_SEL0", "PLL profile multiplexer SEL0 control" };

static const struct LMS8Parameter PLL_CFG_SEL1_INTERNAL = { 0x4009, 11, 11, 1, "PLL_CFG_SEL1_INTERNAL", "PLL profile multiplexer SEL1 signal is generated from" };
static const struct LMS8Parameter PLL_CFG_SEL1_INVERT = { 0x4009, 10, 10, 0, "PLL_CFG_SEL1_INVERT", "Invert the SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK0 = { 0x4009, 0, 0, 0, "PLL_CFG_SEL1_MASK0", "GPIO0 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK1 = { 0x4009, 1, 1, 0, "PLL_CFG_SEL1_MASK1", "GPIO1 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK2 = { 0x4009, 2, 2, 0, "PLL_CFG_SEL1_MASK2", "GPIO2 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK3 = { 0x4009, 3, 3, 0, "PLL_CFG_SEL1_MASK3", "GPIO3 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK4 = { 0x4009, 4, 4, 0, "PLL_CFG_SEL1_MASK4", "GPIO4 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK5 = { 0x4009, 5, 5, 0, "PLL_CFG_SEL1_MASK5", "GPIO5 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK6 = { 0x4009, 6, 6, 0, "PLL_CFG_SEL1_MASK6", "GPIO6 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK7 = { 0x4009, 7, 7, 0, "PLL_CFG_SEL1_MASK7", "GPIO7 mask for SEL1 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL1_MASK8 = { 0x4009, 8, 8, 0, "PLL_CFG_SEL1_MASK8", "GPIO8 mask for SEL1 signal of PLL profile multiplexer" };

static const struct LMS8Parameter PLL_CFG_SEL1 = { 0x4009, 11, 0, 0x0800, "PLL_CFG_SEL1", "PLL profile multiplexer SEL1 control" };

static const struct LMS8Parameter PLL_CFG_SEL2_INTERNAL = { 0x400A, 11, 11, 1, "PLL_CFG_SEL2_INTERNAL", "PLL profile multiplexer SEL1 signal is generated from" };
static const struct LMS8Parameter PLL_CFG_SEL2_INVERT = { 0x400A, 10, 10, 0, "PLL_CFG_SEL2_INVERT", "Invert the SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK0 = { 0x400A, 0, 0, 0, "PLL_CFG_SEL2_MASK0", "GPIO0 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK1 = { 0x400A, 1, 1, 0, "PLL_CFG_SEL2_MASK1", "GPIO1 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK2 = { 0x400A, 2, 2, 0, "PLL_CFG_SEL2_MASK2", "GPIO2 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK3 = { 0x400A, 3, 3, 0, "PLL_CFG_SEL2_MASK3", "GPIO3 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK4 = { 0x400A, 4, 4, 0, "PLL_CFG_SEL2_MASK4", "GPIO4 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK5 = { 0x400A, 5, 5, 0, "PLL_CFG_SEL2_MASK5", "GPIO5 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK6 = { 0x400A, 6, 6, 0, "PLL_CFG_SEL2_MASK6", "GPIO6 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK7 = { 0x400A, 7, 7, 0, "PLL_CFG_SEL2_MASK7", "GPIO7 mask for SEL2 signal of PLL profile multiplexer" };
static const struct LMS8Parameter PLL_CFG_SEL2_MASK8 = { 0x400A, 8, 8, 0, "PLL_CFG_SEL2_MASK8", "GPIO8 mask for SEL2 signal of PLL profile multiplexer" };

static const struct LMS8Parameter PLL_CFG_SEL2 = { 0x400A, 11, 0, 0x0800, "PLL_CFG_SEL2", "PLL profile multiplexer SEL2 control" };

static const struct LMS8Parameter PLL_CFG_INT_SEL0 = { 0x400B, 0, 0, 0, "PLL_CFG_INT_SEL0", "Internal PLL profile control - Bit 0" };
static const struct LMS8Parameter PLL_CFG_INT_SEL1 = { 0x400B, 1, 1, 0, "PLL_CFG_INT_SEL1", "Internal PLL profile control - Bit 1" };
static const struct LMS8Parameter PLL_CFG_INT_SEL2 = { 0x400B, 2, 2, 0, "PLL_CFG_INT_SEL2", "Internal PLL profile control - Bit 2" };
...
static const struct LMS8Parameter PLL_FLOCK_INTVAL = { 0x400B, 3, 3, 0, "PLL_FLOCK_INTVAL", "Fast lock control internal select value" };
...
static const struct LMS8Parameter SEL_BIAS_CORE = { 0x400E, 10, 10, 0, "SEL_BIAS_CORE", "Selects the bias for the core of  LO Distribution Network" };
static const struct LMS8Parameter PLL_LODIST_ICT_CORE = { 0x400E, 9, 5, 8, "PLL_LODIST_ICT_CORE", "Controls the IP20FRP bias current value when SEL_BIAS_CORE=1" };
static const struct LMS8Parameter PLL_LODIST_ICT_BUF = { 0x400E, 4, 0, 8, "PLL_LODIST_ICT_BUF", "Controls the input bias current value for LO Distribution Network output buffers" };

static const struct LMS8Parameter PLL_ICT_OUT0 = { 0x400F, 1, 0, 2, "PLL_ICT_OUT0", "Controls the current drive-strength of the LO Distribution Network Output Buffer Stage for CHA" };
static const struct LMS8Parameter PLL_ICT_OUT1 = { 0x400F, 3, 2, 2, "PLL_ICT_OUT1", "Controls the current drive-strength of the LO Distribution Network Output Buffer Stage for CHB" };
static const struct LMS8Parameter PLL_ICT_OUT2 = { 0x400F, 5, 4, 2, "PLL_ICT_OUT2", "Controls the current drive-strength of the LO Distribution Network Output Buffer Stage for CHB" };
static const struct LMS8Parameter PLL_ICT_OUT3 = { 0x400F, 7, 6, 2, "PLL_ICT_OUT3", "Controls the current drive-strength of the LO Distribution Network Output Buffer Stage for CHB" };
...
static const struct LMS8Parameter PLL_LODIST_EN_BIAS_n = { 0x4100, 12, 12, 0, "PLL_LODIST_EN_BIAS_n", "Enable for LO distribution bias" };
static const struct LMS8Parameter PLL_LODIST_EN_DIV2IQ_n = { 0x4100, 11, 11, 0, "PLL_LODIST_EN_DIV2IQ_n", "Enable for IQ generator in LO distribution" };
static const struct LMS8Parameter PLL_EN_VTUNE_COMP_n = { 0x4100, 10, 10, 0, "PLL_EN_VTUNE_COMP_n", "Enable for tuning voltage comparator in PLL" };
...
static const struct LMS8Parameter PLL_EN_CPOFS_n = { 0x4100, 6, 6, 0, "PLL_EN_CPOFS_n", "Enable for offset (bleeding) current in charge pump" };
...
static const struct LMS8Parameter VTUNE_VCT_n = { 0x4102, 6, 5, 1, "VTUNE_VCT_n", "Tuning voltage control word during coarse tuning (LPFSW=1)" };
...
static const struct LMS8Parameter SPDUP_VCO_n = { 0x4106, 12, 12, 0, "SPDUP_VCO_n", "Speed-up VCO core by bypassing the noise filter" };
static const struct LMS8Parameter VCO_AAC_EN_n = { 0x4106, 11, 11, 1, "VCO_AAC_EN_n", "Enable for automatic VCO amplitude control" };
...
static const struct LMS8Parameter FF_MOD_n = { 0x4107, 1, 0, 0, "FF_MOD_n", "Multiplexer for divider outputs. In normal operation FF_MOD should be equal to FFCORE_MOD." };
...
static const struct LMS8Parameter SEL_SDMCLK_n = { 0x4108, 12, 12, 0, "SEL_SDMCLK_n", "Selects between the feedback divider output and FREF for SDM" };
...
static const struct LMS8Parameter FRACMODL_n = { 0x4109, 15, 0, 22320, "FRACMODL_n", "Fractional control of the division ratio LSB" };
static const struct LMS8Parameter FRACMODH_n = { 0x410A, 3, 0, 5, "FRACMODH_n", "Fractional control of the division ratio MSB" };

static const struct LMS8Parameter PLL_LODIST_EN_OUT_n = { 0x410B, 15, 12, 0, "PLL_LODIST_EN_OUT_n", "LO distribution enable signals" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT3_n = { 0x410B, 11, 9, 0, "PLL_LODIST_FSP_OUT3_n", "LO distribution channel D frequency, sign and phase control" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT2_n = { 0x410B, 8, 6, 0, "PLL_LODIST_FSP_OUT2_n", "LO distribution channel C frequency, sign and phase control" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT1_n = { 0x410B, 5, 3, 0, "PLL_LODIST_FSP_OUT1_n", "LO distribution channel B frequency, sign and phase control" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT0_n = { 0x410B, 2, 0, 0, "PLL_LODIST_FSP_OUT0_n", "LO distribution channel A frequency, sign and phase control" };
...
static const struct LMS8Parameter FLOCK_PULSE_n = { 0x410D, 11, 6, 63, "FLOCK_PULSE_n", "Charge pump pulse current used during fast lock" };
static const struct LMS8Parameter FLOCK_OFS_n = { 0x410D, 5, 0, 0, "FLOCK_OFS_n", "Charge pump offset (bleeding) current used during fast lock" };
static const struct LMS8Parameter FLOCK_LODIST_EN_OUT_n = { 0x410E, 14, 11, 0, "FLOCK_LODIST_EN_OUT_n", "LO distribution enable signals used during fast lock" };
static const struct LMS8Parameter FLOCK_VCO_SPDUP_n = { 0x410E, 10, 10, 0, "FLOCK_VCO_SPDUP_n", "VCO speedup used during fast lock" };
static const struct LMS8Parameter FLOCK_N_n = { 0x410E, 9, 0, 400, "FLOCK_N_n", "Duration of fast lock in PLL reference frequency clock cycles" };

static const struct LMS8Parameter FLOCK_LODIST_EN_OUT0_n = { 0x410E, 11, 11, 0, "FLOCK_LODIST_EN_OUT0_n", "LO distribution enable signal used during fast lock - Channel A" };
static const struct LMS8Parameter FLOCK_LODIST_EN_OUT1_n = { 0x410E, 12, 12, 0, "FLOCK_LODIST_EN_OUT1_n", "LO distribution enable signal used during fast lock - Channel B" };
static const struct LMS8Parameter FLOCK_LODIST_EN_OUT2_n = { 0x410E, 13, 13, 0, "FLOCK_LODIST_EN_OUT2_n", "LO distribution enable signal used during fast lock - Channel C" };
static const struct LMS8Parameter FLOCK_LODIST_EN_OUT3_n = { 0x410E, 14, 14, 0, "FLOCK_LODIST_EN_OUT3_n", "LO distribution enable signal used during fast lock - Channel D" };

static const struct LMS8Parameter PLL_LODIST_EN_OUT0_n = { 0x410B, 12, 12, 0, "PLL_LODIST_EN_OUT0_n", "LO distribution enable signal - Channel A" };
static const struct LMS8Parameter PLL_LODIST_EN_OUT1_n = { 0x410B, 13, 13, 0, "PLL_LODIST_EN_OUT1_n", "LO distribution enable signal - Channel B" };
static const struct LMS8Parameter PLL_LODIST_EN_OUT2_n = { 0x410B, 14, 14, 0, "PLL_LODIST_EN_OUT2_n", "LO distribution enable signal - Channel C" };
static const struct LMS8Parameter PLL_LODIST_EN_OUT3_n = { 0x410B, 15, 15, 0, "PLL_LODIST_EN_OUT3_n", "LO distribution enable signal - Channel D" };

static const struct LMS8Parameter PLL_LODIST_FSP_OUT02_n = { 0x410B, 2, 2, 0, "PLL_LODIST_FSP_OUT02_n", "LO distribution channel A - Divide by 2" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT12_n = { 0x410B, 5, 5, 0, "PLL_LODIST_FSP_OUT12_n", "LO distribution channel B - Divide by 2" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT22_n = { 0x410B, 8, 8, 0, "PLL_LODIST_FSP_OUT22_n", "LO distribution channel C - Divide by 2" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT32_n = { 0x410B, 11, 11, 0, "PLL_LODIST_FSP_OUT32_n", "LO distribution channel D - Divide by 2" };

static const struct LMS8Parameter PLL_LODIST_FSP_OUT010_n = { 0x410B, 1, 0, 0, "PLL_LODIST_FSP_OUT010_n", "LO distribution channel A - Phase control" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT110_n = { 0x410B, 4, 3, 0, "PLL_LODIST_FSP_OUT110_n", "LO distribution channel B - Phase control" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT210_n = { 0x410B, 7, 6, 0, "PLL_LODIST_FSP_OUT210_n", "LO distribution channel C - Phase control" };
static const struct LMS8Parameter PLL_LODIST_FSP_OUT310_n = { 0x410B, 10, 9, 0, "PLL_LODIST_FSP_OUT310_n", "LO distribution channel D - Phase control" };
